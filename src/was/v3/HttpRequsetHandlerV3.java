...
public class HttpRequsetHandlerV3 implements Runnable {
    private final Socket socket;

    public HttpRequsetHandlerV3(Socket socket) {
        this.socket = socket;
    }
    ...
    private String requsetToString(BufferedReader reader) throws IOException {
